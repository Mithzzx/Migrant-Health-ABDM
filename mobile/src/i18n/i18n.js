...
const translations = {
  ...
  medicines: 'മരുന്നുകൾ',
  records: 'റെക്കോർഡുകൾ',
  healthRecords: 'ആരോഗ്യ റെക്കോർഡുകൾ',
  searchHealthRecords: 'ആരോഗ്യ റെക്കോർഡുകൾ തിരയുക...',
  allRecords: 'എല്ലാ റെക്കോർഡുകളും',
  diagnosticReport: 'ഡയഗ്നോസ്റ്റിക് റിപ്പോർട്ട്',
  dischargeSummary: 'ഡിസ്ചാർജ് സമ്മറി',
  labReport: 'ലാബ് റിപ്പോർട്ട്',
  prescription: 'കുറിപ്പ്',
  immunizationRecord: 'വാക്സിനേഷൻ റെക്കോർഡ്',
  opConsultation: 'OP കൺസൾട്ടേഷൻ',
